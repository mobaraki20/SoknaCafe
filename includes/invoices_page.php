    ...
    <section class="card financial-page-shell financial-index-surface" data-financial-index-shell="invoices">
      ...
      <div class="financial-page-toolbar">
        <form method="get" class="financial-search-form" role="search">
          ...
          <label class="financial-search-field"><span class="sr-only">جست‌وجوی فاکتورها</span><input class="form-control" type="search" inputmode="search" enterkeyhint="search" autocomplete="off" name="q" value="<?= e($q) ?>" placeholder="جست‌وجوی فاکتور، میز، مشترک، مهمان یا اتاق"></label>
        </form>
