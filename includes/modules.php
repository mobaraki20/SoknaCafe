...
function sokna_module_registry(): array
{
    ...
    $registry = [
        ...
        'finance' => [
            ...
            'owns_tables' => ['financial_periods','settlement_records','settlement_record_lines','invoice_discount_audit'],
        ...
        'printing' => [
            ...
            'owner' => 'includes/printing.php + print-agent/v4/',
            ...
            'capabilities' => [],
            'background_jobs' => ['Windows Print Agent (GitHub stable release)','tools/print-v4-staging-preflight.php'],
        ...
        'notifications' => [
            ...
            'owner' => 'includes/push.php + service-worker.js',
            ...
            'background_jobs' => ['tools/push-worker.php','opportunistic api/push_drain.php'],
