...
with sync_playwright() as p:
    ...
    for width,height in SIZES:
        ...
        if width == 390:
            ...
            page.locator('#submitOrder').click();page.wait_for_timeout(80)
            assert page.locator('#guestConfirmModal').is_visible()
            assert 'مبلغ نهایی' in page.locator('#guestConfirmText').inner_text()
            page.locator('#guestConfirmAccept').click();page.wait_for_timeout(160)
