...
<section class="print5-release-strip"><div><span class="print5-status-dot is-ok"></span><div><strong>برنامه چاپ ویندوز 6.2.0</strong><small>نسخه پیشنهادی سامانه برای نصب و ارتقا</small></div></div><div class="actions"><a class="btn btn-primary">دانلود Agent 6.2.0</a><a class="btn btn-light">جزئیات نسخه</a></div></section>
<section class="print5-status-strip is-warn"><div class="print5-status-main"><span class="print5-health-icon is-warn"></span><div><strong>چاپ نیازمند رسیدگی است</strong><small>آخرین تحویل موفق به صف چاپ: امروز</small></div></div><div class="print5-status-facts"><span><b>۱/۱</b> Agent آنلاین</span><span><b>۲/۲</b> مقصد آماده</span><span class="is-problem"><b>۱</b> نیازمند رسیدگی</span></div><button class="btn btn-light">تازه‌سازی</button></section>
<div class="print5-overview-grid"><div class="print5-overview-main"><section class="card print5-ops-card"><div class="card-head"><strong>نیازمند رسیدگی</strong></div><div class="print5-job-list"><article class="print5-job-row is-problem"><header><div><strong>فیش آماده‌سازی</strong><span>امروز</span></div><span class="badge badge-failed">نتیجه نامشخص</span></header><div class="print5-job-human-meta"><span>آماده‌سازی مشترک</span><span>۲ تلاش</span></div><div class="print5-job-actions"><button class="btn btn-light">چاپ انجام شده است</button><button class="btn btn-primary">چاپ مجدد مستقل</button></div></article></div></section></div><aside class="print5-overview-side"><section class="card print5-infra-card"><div class="card-head"><strong>زیرساخت چاپ</strong></div><div class="print5-infra-list"><div class="print5-infra-row"><span class="print5-status-dot is-ok"></span><div><strong>صندوق اصلی</strong><small>DESKTOP-CAFE · Agent 6.2.0</small></div><span>۳ پرینتر</span></div></div></section></aside></div>
<section class="card print5-section"><div class="card-head"><strong>مقصدهای چاپ</strong></div><div class="card-body"><div class="print5-destination-list"><details class="print5-destination-editor"><summary><div><span class="print5-status-dot is-ok"></span><div><strong>سند مشتری</strong><small>صندوق اصلی · EPSON Front</small></div></div><div><span class="print5-state is-ok">آماده</span><span class="print5-edit-label">ویرایش</span></div></summary><form class="print5-destination" data-print-destination><div class="print5-destination-fields"><div class="print5-pair"><label><span>رایانه چاپ</span><select class="form-control" data-print-agent-select="primary"><option value="0">انتخاب نشده</option><option value="1" selected>صندوق اصلی · آنلاین</option><option value="2">پشتیبان · آفلاین</option></select></label></div><div class="print5-pair"><label><span>پرینتر Windows</span><select class="form-control" data-print-printer-select="primary" data-current-printer="EPSON Front"></select></label></div><label class="print5-active"><input type="checkbox" checked><span>این مقصد فعال باشد</span></label></div><details class="print5-destination-advanced"><summary>تنظیمات بیشتر مقصد</summary><div class="print5-advanced-fields"><label><span>رایانه جایگزین</span><select class="form-control" data-print-agent-select="fallback"><option value="0">بدون جایگزین</option><option value="2" selected>پشتیبان</option></select></label><label><span>پرینتر جایگزین</span><select class="form-control" data-print-printer-select="fallback" data-current-printer="Old Queue"></select></label></div></details><div class="print5-destination-footer"><span class="print5-destination-meta">رول ۸۰ میلی‌متر</span><div class="actions"><button class="btn btn-light" type="button" data-print-editor-close>انصراف</button><button class="btn btn-primary">ذخیره تغییرات</button></div></div></form></details></div></div></section>
...
<script type="application/json" id="printing-printers-data">{"1":[{"name":"EPSON Front","default":true,"offline":false},{"name":"Microsoft Print to PDF","default":false,"offline":false}],"2":[]}</script>
</main></body></html>'''
...
with sync_playwright() as p:
    ...
    for width,height in ((1440,980),(1024,900),(390,844)):
        ...
        assert editor.get_attribute('open') is None
        editor.locator(':scope > summary').click()
        page.select_option('[data-print-agent-select="primary"]','2')
        assert primary.is_disabled() is False
        assert 'گزارش نشده' in primary.locator('option').first.inner_text()
        page.select_option('[data-print-agent-select="primary"]','0')
        ...
        page.close()
    browser.close()
print('Printing operations browser passed: 3-section hierarchy, compact desktop overview, edit-on-demand destination mapping, advanced disclosure and no overflow.')
