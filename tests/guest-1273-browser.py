...
with sync_playwright() as p:
    ...
    for width, height in ((320, 720), (390, 844), (412, 915), (1024, 768)):
        ...
        # Quantity control compact touch-safe geometry and physical order.
        ...
        # Detail: professional responsive layout and no clipped footer controls.
        ...
        if width <= 560:
            ...
            assert panel['width'] <= 902
        assert abs(dmedia['width'] - dmedia['height']) < 2, dmedia
        assert page.locator('.item-detail-media img').evaluate('e=>getComputedStyle(e).objectFit') == 'contain'
        ...
        assert abs(target.evaluate('e=>e.getBoundingClientRect().top')-before_top) <= 2.5
        ...
        page.close()
    browser.close()
print('Sokna 1.27.3 square-image and interaction checks passed at 320, 390, 412 and 1024 widths.')
