...
checks={
 ...
 'new_agent_has_no_protocol_discriminator': 'INSERT INTO print_agents(name,token_hash,token_hint,active) VALUES(?,?,?,1)' in admin,
 'v4_heartbeat_does_not_write_protocol_column': 'protocol_version=4' not in v4,
 'single_minimum_agent_version': "function print_agent_minimum_version(): string" in printing and "return '6.0.0';" in printing and 'print_agent_v4_minimum_version' not in printing+v4,
