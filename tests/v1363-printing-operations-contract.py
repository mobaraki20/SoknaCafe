...
need('print_worker_component_metadata' in printing and 'mobaraki20/Pagent' not in printing, 'Print Worker must resolve from the SOKNA-owned internal component metadata')
need('print_agent_download_url()' not in admin and 'print_agent_release_page_url()' not in admin, 'standalone Agent download flow must not return to the printing console')
